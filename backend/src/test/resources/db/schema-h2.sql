...
CREATE INDEX idx_short_link_result_id ON short_link(result_id);
CREATE INDEX idx_short_link_created_at ON short_link(created_at);
...
CREATE INDEX idx_visit_event_event_created ON visit_event(event_type, created_at);
CREATE INDEX idx_visit_event_short_created ON visit_event(short_code, created_at);
CREATE INDEX idx_visit_event_result_created ON visit_event(result_id, created_at);
CREATE INDEX idx_visit_event_client ON visit_event(client_id_hash);
CREATE INDEX idx_visit_event_ip ON visit_event(ip_hash);
CREATE INDEX idx_visit_event_session ON visit_event(session_id_hash);
...
CREATE INDEX idx_visit_event_result_event_channel ON visit_event(result_id, event_type, channel);
CREATE INDEX idx_visit_event_event_short_created_channel ON visit_event(event_type, short_code, created_at, channel);
