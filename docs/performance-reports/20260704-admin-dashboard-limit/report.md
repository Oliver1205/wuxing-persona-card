...
- Run ID: `20260704-admin-dashboard-limit`
- Git SHA: `8569bd7`
- Git state: `clean`
...
- Started: `2026-07-04T16:58:56`
- Workload: `mixed`
- Readiness status: `UP`
- Synthetic Channel: `perf-test`
- Synthetic Campaign: `performance-limit-test`
- Effective Synthetic Campaign: `performance-limit-test:20260704-admin-dashboard-limit`
...
- Result ID: `R20260704165856548564995`
- Short Code: `wDiUrt`
...
- 本轮完成所有阶段，最高 P95 为 8ms，最高错误率为 0.00%。
- 最高并发阶段最慢接口类型是 `admin`，P95 为 11ms，错误数 0。
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 40 | 666.67 | 0.5 | 0 | 2 | 4 | 0.00% | 0 | 0.00% | 32 | 0 | 0 | ok |
| 2 | 40 | 888.89 | 1.18 | 1 | 4 | 5 | 0.00% | 0 | 0.00% | 32 | 0 | 0 | ok |
| 4 | 40 | 1538.46 | 1.3 | 1 | 3 | 3 | 0.00% | 0 | 0.00% | 32 | 0 | 0 | ok |
| 8 | 40 | 1666.67 | 2.6 | 2 | 4 | 5 | 0.00% | 0 | 0.00% | 32 | 0 | 0 | ok |
| 16 | 40 | 1600.0 | 4.15 | 4 | 8 | 11 | 0.00% | 0 | 0.00% | 32 | 0 | 0 | ok |
