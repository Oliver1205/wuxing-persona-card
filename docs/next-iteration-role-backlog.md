...
| 角色 | 新发现 | 状态 |
| --- | --- | --- |
| 产品经理 | 文档站“立即体验 H5”不应绕 README；首页和结果页 CTA 还可以进一步收束 | Phase 55 已把文档站体验区改成直接本地 H5 入口和启动命令；Phase 58 已补首页样例卡继续入口；Phase 62 已把结果页分享按钮改为明确动作文案 |
| 普通访问者 | 前台应少说“短链”，多说“分享链接”；出生年月需要隐私和低成本解释 | Phase 47 已部分落地；Phase 61 已将前台首页、结果页、分享框和分享图文案改为“分享链接”；Phase 62 已区分复制分享链接与系统分享 |
...
- Phase 62：结果页分享框按钮改为“复制分享链接”和“系统分享”，减少用户对“复制/分享”两个短按钮的猜测成本。
